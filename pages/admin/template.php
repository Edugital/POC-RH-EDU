...
<body <?php echo isset($bodyDataAttributes) ? $bodyDataAttributes : ''; ?>>
    <div class="app-container">
        ...
        <aside class="sidebar">
            ...
            <?php include dirname(__DIR__, 2) . '/includes/menu.php'; ?>
    ...
    <!-- Conditional loading of demo-lms.js only on LMS pages -->
    <?php 
    // Only load demo-lms.js on LMS pages, not on organizational structure page
    $isLmsPage = !in_array($currentPage, ['estrutura_organizacional.php']);
    if ($isLmsPage): 
    ?>
